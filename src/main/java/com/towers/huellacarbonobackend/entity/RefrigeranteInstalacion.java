...
public class RefrigeranteInstalacion extends Refrigerante {
    ...
    public RefrigeranteInstalacion(Long id, TipoEquipo tipoEquipo, TipoRefrigerante tipoRefrigerante, Double numeroEquipos, Double capacidadCarga, Double fugaInstalacion) {
